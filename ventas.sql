...
(
    ...
    precio_sugerido INT UNSIGNED NOT NULL,
...
(
    ...
    claveAliente_id INT UNSIGNED NOT NULL REFERENCES clave_cliente.id ON UPDATE CASCADE,
...
(
    ...
    activo BOOL NOT NULL,
    ciudad_id INT UNSIGNED NOT NULL REFERENCES ciudad.id ON UPDATE CASCADE
);
