...
protected:
	...
	void InitializeGui()
	{
		...
		lbInicio.CreateX(NULL, L"Inicio", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 13.73188, 1.85208, 0.95250, 0.60854, hWnd, 1016);
		lbFinal.CreateX(NULL, L"Final", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 17.11854, 1.85208, 0.95250, 0.60854, hWnd, 1017);
		btImprimir.CreateX(NULL, L"Imprimir", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 21.06083, 0.79375, 2.91042, 0.68792, hWnd, 1018);
