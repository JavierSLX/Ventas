...
protected:
	...
	void InitializeGui()
	{
		...
		btAgregarLada.CreateX(NULL, L"+", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 8.17563, 1.42875, 1.03188, 0.68792, hWnd, 1007);
	...
	void btAgregarLada_Click(Win::Event& e);
	...
	bool EventHandler(Win::Event& e)
	{
		...
		if (btAgregarLada.IsEvent(e, BN_CLICKED)) {btAgregarLada_Click(e); return true;}
		return false;
	}
};
