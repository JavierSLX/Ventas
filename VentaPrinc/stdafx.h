...
#define CONNECTION_STRING L"Driver={MySQL ODBC 5.3 UNICODE Driver};Server=localhost;Database=pruebasmarquesada;Port=3300;User=root;Password=root;Option=1;"
