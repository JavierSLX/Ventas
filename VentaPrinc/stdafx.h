...
#define CONNECTION_STRING L"Driver={MySQL ODBC 5.3 UNICODE Driver};Server=192.168.1.121;Database=pruebasmarquesada;Port=3300;User=principal;Password=marquesada?466;Option=1;"
