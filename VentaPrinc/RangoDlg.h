...
protected:
	...
	void InitializeGui()
	{
		...
		btActualizar.CreateX(NULL, L"Actualizar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 7.38188, 2.01083, 2.51354, 0.68792, hWnd, 1004);
		...
		lbMinimo.CreateX(NULL, L"Rango Mínimo", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 0.68792, 0.18521, 3.41313, 0.60854, hWnd, 1007);
