...
protected:
	...
	{
		dlgTemplate.cx=Sys::Convert::CentimetersToDlgUnitX(7.01146);
	...
	void InitializeGui()
	{
		lb1.CreateX(NULL, L"Región", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 0.79375, 0.29104, 1.66688, 0.74083, hWnd, 1000);
		tbxRegion.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 0.52917, 1.29646, 2.16958, 0.68792, hWnd, 1001);
		btAgregar.CreateX(NULL, L"Agregar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 0.52917, 2.54000, 2.16958, 0.68792, hWnd, 1002);
		btActualizar.CreateX(NULL, L"Actualizar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 0.52917, 3.70417, 2.16958, 0.68792, hWnd, 1003);
		lvRegion.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_REPORT, 3.75708, 0.26458, 3.06917, 4.10104, hWnd, 1004);
