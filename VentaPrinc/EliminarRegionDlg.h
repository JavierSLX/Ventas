...
protected:
	...
	{
		dlgTemplate.cx=Sys::Convert::CentimetersToDlgUnitX(7.30250);
		dlgTemplate.cy=Sys::Convert::CentimetersToDlgUnitY(9.44562);
		dlgTemplate.style = WS_CAPTION | WS_POPUP | WS_SYSMENU | WS_VISIBLE | DS_CENTER | DS_MODALFRAME;
	}
	//_________________________________________________
	void InitializeGui()
	{
		tabRegion.CreateX(NULL, NULL, WS_CHILD | WS_VISIBLE | TCS_SINGLELINE | TCS_TABS | TCS_RAGGEDRIGHT, 1.37583, 1.37583, 5.74146, 6.87917, hWnd, 1000);
		lvRegion.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_REPORT, 1.79917, 2.54000, 4.97417, 5.42396, hWnd, 1001);
		btEliminar.CreateX(NULL, L"Eliminar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 1.00542, 8.54604, 2.80458, 0.68792, hWnd, 1002);
		btRestaurar.CreateX(NULL, L"Restaurar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 4.25979, 8.57250, 2.75167, 0.68792, hWnd, 1003);
