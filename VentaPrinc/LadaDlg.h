...
protected:
	...
	{
		dlgTemplate.cx=Sys::Convert::CentimetersToDlgUnitX(10.53042);
		dlgTemplate.cy=Sys::Convert::CentimetersToDlgUnitY(10.84792);
		dlgTemplate.style = WS_CAPTION | WS_POPUP | WS_SYSMENU | WS_VISIBLE | DS_CENTER | DS_MODALFRAME;
	}
	//_________________________________________________
	void InitializeGui()
	{
		lb1.CreateX(NULL, L"Lada", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 4.07458, 0.29104, 1.08479, 0.76729, hWnd, 1000);
		...
		lvLada.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_REPORT, 4.20688, 1.45521, 6.13833, 9.20750, hWnd, 1006);
