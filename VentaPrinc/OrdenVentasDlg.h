...
protected:
	...
	{
		dlgTemplate.cx=Sys::Convert::CentimetersToDlgUnitX(6.64104);
	...
	void InitializeGui()
	{
		...
		lbCliente.CreateX(NULL, L"Cliente", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 1.74625, 2.38125, 4.60375, 0.60854, hWnd, 1002);
		ddCliente.CreateX(NULL, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | WS_VSCROLL | CBS_DROPDOWNLIST | CBS_WINNORMALCASE, 3.91583, 3.30729, 2.48708, 0.71437, hWnd, 1003);
		lbPuntoVenta.CreateX(NULL, L"Departamento", WS_CHILD | WS_VISIBLE | SS_LEFT | SS_WINNORMAL, 1.77271, 5.71500, 4.65667, 0.60854, hWnd, 1004);
		ddPuntoVenta.CreateX(NULL, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | WS_VSCROLL | CBS_DROPDOWNLIST | CBS_WINNORMALCASE, 1.71979, 6.66750, 4.73604, 0.76729, hWnd, 1005);
		...
		tbxIdentificador.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 1.74625, 3.36021, 1.79917, 0.76729, hWnd, 1007);
		tbxNombreCliente.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_LEFT | ES_WINNORMALCASE, 1.71979, 4.52438, 4.68312, 0.84667, hWnd, 1008);
