...
protected:
	...
	{
		dlgTemplate.cx=Sys::Convert::CentimetersToDlgUnitX(7.64646);
		dlgTemplate.cy=Sys::Convert::CentimetersToDlgUnitY(9.20750);
		dlgTemplate.style = WS_CAPTION | WS_POPUP | WS_SYSMENU | WS_VISIBLE | DS_CENTER | DS_MODALFRAME;
	}
	//_________________________________________________
	void InitializeGui()
	{
		tabLada.CreateX(NULL, NULL, WS_CHILD | WS_VISIBLE | TCS_SINGLELINE | TCS_TABS | TCS_RAGGEDRIGHT, 0.82021, 0.50271, 6.29708, 7.56708, hWnd, 1000);
		lvLada.CreateX(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | LVS_REPORT, 1.24354, 1.56104, 5.47687, 6.03250, hWnd, 1001);
		btEliminar.CreateX(NULL, L"Eliminar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 0.58208, 8.33437, 2.93688, 0.68792, hWnd, 1002);
		btRestaurar.CreateX(NULL, L"Restaurar", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 4.52438, 8.33437, 2.93688, 0.68792, hWnd, 1003);
